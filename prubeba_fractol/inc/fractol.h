...
#define ERROR_MASSAGE "Please enter \n\t\"./fractol mandelbrot\" or \n\t"./fractol julia <value_1> <value_2>\"\n"
...
//** render **
void	fractal_rendel(t_fractal *fractal);
...
//** hooks_events **
int	key_hendler(int keysym, t_fractal *fractal);

//** clean_up **
int	close_handler(t_fractal *fractal);
int	muse_handeler(int button, int x, int y, t_fractal *fractal);
