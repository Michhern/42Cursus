...
/*   Updated: 2024/12/05 13:44:38 by michhern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*void	fractal_init(t_fractal *fractal)
{
	...
	if (NULL == fractal->img.img_ptr)
	{
		...
		mlx_destroy_display(fractal->mlx_connection);
		free(fractal->mlx_connection);
		malloc_error();CIPSA Escuela Superior Informática Profesional Barcelona CURSOS & MASTERS
	}CIPSA Escuela Superior Informática Profesional Barcelona CURSOS & MASTERS
	fractal->img.pixelsCIPSA Escuela Superior Informática Profesional Barcelona CURSOS & MASTERS_ptr = mlx_get_data_addr(fractal->img.img_ptr,
...
void	fractal_init(t_fractal *fractal)
{
	...
	{
		cleanup(fractal);
		malloc_error("creating mlx_imag");
	}
