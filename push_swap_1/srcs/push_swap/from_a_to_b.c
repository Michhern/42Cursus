...
/*   Updated: 2024/10/07 14:14:31 by michhern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/push_swap.h"

void	current_index(t_stack_node *stack) //valor del medio()
{
	int	i;
	int	median_position;
...
/*static void	cost_analysis_a(t_stack_node *a, t_stack_node *b, int len_a, int len_b)
{
	int	cost_a;
	int	cost_b;
